 ...
 */
 ...
 public:
   ...
   */
   ...
   public:
     Iterator();
     Iterator(std::deque<Point>& work,const PNG & png, Point & start, double tolerance, add_function traversal_add, pop_function traversal_pop);
     ...
     Point curData;
     bool inWorkList(Point p);
     void updateWorkList(Point p);
     std::deque<Point> getWorkList();
     bool getEndFlag();
